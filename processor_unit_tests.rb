...
class TestProcessor < Test::Unit::TestCase
    def test_extract_sequences_from_original_word
        pro = Processor.new
        short_seqs = pro.extract_sequences_from_original_word "abc"
        assert_equal [], short_seqs
        
        seqs = pro.extract_sequences_from_original_word "hello"
